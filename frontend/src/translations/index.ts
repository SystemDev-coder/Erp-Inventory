...
export const translations = {
  ...
  card_total_customers_title: { en: 'Total Customers', so: 'Wadarta Macaamiisha' },
  card_total_customers_subtitle: { en: 'Registered customers', so: 'Macaamiisha Diiwaangashan' },
  card_total_employees_title: { en: 'Total Employees', so: 'Wadarta Shaqaalaha' },
  card_total_employees_subtitle: { en: 'Active employees', so: 'Shaqaalaha Firfircoon' },
  card_total_products_title: { en: 'Total Products', so: 'Wadarta Alaabta' },
  card_total_products_subtitle: { en: 'Active products', so: 'Alaabta Firfircoon' },
  card_total_suppliers_title: { en: 'Total Suppliers', so: 'Wadarta Alaab-bixiyeyaasha' },
  card_total_suppliers_subtitle: { en: 'Active suppliers', so: 'Alaab-bixiyeyaasha Firfircoon' },
  card_monthly_income_title: { en: 'Monthly Income', so: 'Dakhliga Bishan' },
  card_monthly_income_subtitle: { en: 'Sales this month', so: 'Iibka Bishan' },
  card_total_purchases_title: { en: 'Total Purchases', so: 'Wadarta Iibsiga' },
  card_total_purchases_subtitle: { en: 'Received purchases this month', so: 'Iibsiga la Helay Bishan' },
  card_total_expenses_title: { en: 'Total Expenses', so: 'Wadarta Kharashaadka' },
  card_total_expenses_subtitle: { en: 'Expenses booked this month', so: 'Kharashaadka Bishan la Diiwaangeliyay' },
  card_monthly_payment_title: { en: 'Monthly Payment', so: 'Lacag-bixinta Bishan' },
  card_monthly_payment_subtitle: {
    en: 'Expenses + salary this month',
    so: 'Kharashaadka + Mushaharka Bishan',
  },
  card_total_revenue_title: { en: 'Total Revenue', so: 'Wadarta Dakhliga' },
  card_total_revenue_subtitle: {
