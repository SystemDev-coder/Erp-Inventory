...
export const translations = {
  ...
  card_inventory_stock_title: { en: 'Inventory Stock', so: 'Bakhaarka Alaabta' },
  card_inventory_stock_subtitle: { en: 'Units in stock', so: 'Cadadka Bakhaarka ku Jira' },
  card_low_stock_title: { en: 'Low Stock Alert', so: 'Digniinta Bakhaarka Yaraaday' },
  card_low_stock_subtitle: {
    en: 'Items below reorder level',
    so: 'Alaabta ka Hoosaysa Heerka Dib-u-dalbashada',
  },
  ...
  card_today_payment_title: { en: 'Today Payment', so: 'Lacag-bixinta Maanta' },
  card_today_payment_subtitle: { en: 'Expenses + salary', so: 'Kharashaadka + Mushaharka' },
