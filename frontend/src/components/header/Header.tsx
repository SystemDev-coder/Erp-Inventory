...
const Header: React.FC<HeaderProps> = ({ onClick, onToggle }) => {
  ...
  return (
    <header className="erp-header sticky top-0 flex w-full border-gray-200 z-99999 lg:border-b">
            ...
            <form action="https://formbold.com/s/unique_form_id" method="POST">
              <div className="relative">
                ...
                <input
                  ...
                  className="erp-header-search h-11 w-full rounded-lg border py-2.5 pl-12 pr-14 text-sm shadow-theme-xs focus:outline-hidden xl:w-[430px]"
                />

                <button className="erp-header-kbd absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border px-[7px] py-[4.5px] text-xs -tracking-[0.2px]">
                  <span> Cmd </span>
                  <span> K </span>
                </button>
              </div>
