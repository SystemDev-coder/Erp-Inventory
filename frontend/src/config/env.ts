...
export const API = {
  ...
  AUTH: {
    ...
    ME: '/api/auth/me',
    MY_BRANCHES: '/api/auth/my-branches',
  ...
  REPORTS: {
    ...
    SALES_INVOICE_STATUS: '/api/reports/sales/invoice-status',
    ...
    SALES_PAYMENTS_BY_ACCOUNT: '/api/reports/sales/payments-by-account',
    SALES_QUOTATIONS: '/api/reports/sales/quotations',
    ...
    INVENTORY_STORE_MOVEMENT_SUMMARY: '/api/reports/inventory/store-movement-summary',
    INVENTORY_STORE_MOVEMENT_DETAIL: '/api/reports/inventory/store-movement-detail',
    INVENTORY_FOUND: '/api/reports/inventory/found',
    ...
    PURCHASE_CREDIT_OVERDUE: '/api/reports/purchase/credit-overdue',
    ...
    FINANCIAL_COGS_BY_INVOICE: '/api/reports/financial/cogs',
    ...
    HR_PAYROLL_EMPLOYEE_DETAIL: '/api/reports/hr/payroll-employee-detail',
    ...
    CUSTOMER_CREDIT_OVERDUE: '/api/reports/customer/credit-overdue',
