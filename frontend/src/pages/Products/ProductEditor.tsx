      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800">
          ...
          >
            ...
            <div className="md:col-span-2 flex justify-end gap-2 pt-4 border-t border-slate-100 dark:border-slate-700 mt-1">
              <button
                type="button"
                onClick={() => navigate('/items')}
                className="px-4 py-2 text-sm rounded-lg border border-slate-300 text-slate-600 hover:bg-slate-50 dark:border-slate-600 dark:text-slate-300 dark:hover:bg-slate-800"
              >
                Cancel
              </button>
              <button
                type="submit"
                disabled={saving}
                className="px-5 py-2 text-sm rounded-lg bg-primary-600 text-white hover:bg-primary-700 disabled:cursor-not-allowed disabled:opacity-60"
              >
                {saving ? 'Saving...' : itemForm.product_id ? 'Update Product' : 'Save Product'}
              </button>
            </div>
          </form>
        </div>
