...
export function CustomerReportsTab({ onOpenModal }: Props) {
  ...
  const [ledgerRange, setLedgerRange] = useState<DateRange>(defaultReportRange());const [paymentHistoryRange, setPaymentHistoryRange] = useState<DateRange>(defaultReportRange());
