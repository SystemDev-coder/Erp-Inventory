...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | KeydMaal ERP - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for KeydMaal ERP - React.js Tailwind CSS Admin Dashboard Template"
      />
