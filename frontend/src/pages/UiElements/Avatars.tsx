...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | KeydMaal ERP - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for KeydMaal ERP - React.js Tailwind CSS Admin Dashboard Template"
      />
