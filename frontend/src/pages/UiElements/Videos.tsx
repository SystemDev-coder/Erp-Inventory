...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | KeydMaal ERP - React.js Admin Dashboard Template"
        description="This is React.js Videos page for KeydMaal ERP - React.js Tailwind CSS Admin Dashboard Template"
      />
