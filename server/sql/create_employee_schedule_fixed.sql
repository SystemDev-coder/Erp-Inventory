...
INSERT INTO ims.employee_schedule (emp_id, schedule_type, start_date, end_date, reason, status)
VALUES 
  (11, 'vacation', '2026-03-01', '2026-03-07', 'Family vacation', 'approved'),
  (12, 'sick_leave', '2026-02-20', '2026-02-22', 'Medical appointment', 'approved'),
  (13, 'vacation', '2026-04-15', '2026-04-20', 'Personal time off', 'pending')
ON CONFLICT DO NOTHING;

COMMIT;

SELECT 'Schedule system created successfully!' as message;
