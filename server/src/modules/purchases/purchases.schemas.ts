...
export const purchaseSchema = z.object({
  ...
  // NEW: Distinguish purchase vs purchase order (order has no stock/ledger impact until received).
  docType: z.enum(['purchase', 'order']).default('purchase').optional(),
  ...
  status: z.enum(['ordered', 'received', 'partial', 'unpaid', 'void']).default('received'),
