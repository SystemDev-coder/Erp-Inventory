...
// NEW: User privileges management (uses ims.user_permission_overrides only)
router.get(
  '/users/:id/permissions',
  requireAnyPerm(['system.permissions.manage', 'users.view', 'system.users.manage']),
  getUserPermissions
);
router.put(
  '/users/:id/permissions',
  requireAnyPerm(['system.permissions.manage', 'users.update', 'system.users.manage']),
  updateUserPermissionOverrides
);
