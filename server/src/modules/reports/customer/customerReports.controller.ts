...
import { salesReportsService } from '../sales/salesReports.service';
...
export const getCustomerListReport = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  return ApiResponse.success(res, reportRows(branchId, { reportKey: 'customer-list', mode, customerId: customerId ?? null, rows }, rows, REPORT_ROW_LIMITS.customerList));
});
...
export const getCustomerLedgerReport = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  return ApiResponse.success(res, reportRows(branchId, { reportKey: 'customer-ledger', fromDate, toDate, mode, customerId: customerId ?? null, rows }, rows, REPORT_ROW_LIMITS.customerLedger));
});
...
export const getOutstandingBalancesReport = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  return ApiResponse.success(res, reportRows(branchId, { reportKey: 'customer-outstanding-balances', mode, customerId: customerId ?? null, rows }, rows, REPORT_ROW_LIMITS.customerList));
});
...
export const getCustomerPaymentHistoryReport = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  return ApiResponse.success(res, reportRows(branchId, { reportKey: 'customer-payment-history', fromDate, toDate, mode, customerId: customerId ?? null, rows }, rows, REPORT_ROW_LIMITS.customerPayments));
});
...
export const getCreditCustomersReport = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  return ApiResponse.success(res, reportRows(branchId, { reportKey: 'credit-customers', mode, customerId: customerId ?? null, rows }, rows, REPORT_ROW_LIMITS.customerList));
});
...
export const getCreditOverdueReport = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  return ApiResponse.success(res, reportRows(branchId, { reportKey: 'credit-overdue', mode, customerId: customerId ?? null, rows }, rows, REPORT_ROW_LIMITS.customerList));
});
...
export const getNewCustomersReport = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  return ApiResponse.success(res, reportRows(branchId, { reportKey: 'new-customers', fromDate, toDate, rows }, rows, REPORT_ROW_LIMITS.detail));
});
...
export const getCustomerActivityReport = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  return ApiResponse.success(res, reportRows(branchId, { reportKey: 'customer-activity', fromDate, toDate, mode, customerId: customerId ?? null, rows }, rows, REPORT_ROW_LIMITS.customerList));
});
